...
## Communicate the existence of the moving manuals to customers.
...
[ISO Stnadards]( http://www.iso.org/iso/home/standards.htm )
...
[MIT Licence]( http://opensource.org/licenses/MIT ). Other licenses upon agreement.
...
Talk about changes to your code with everyone involved before releasing or incorporating them.
...
* You can access your logs realtime through our API, our log viewer in the Control Panel or via MaxCLI—our command line interface.
* Our realtime reporting system allows you to view, calculate and predict future behavior.
